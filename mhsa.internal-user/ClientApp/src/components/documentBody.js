    ...
    const dataMapper = () => {
        ...
        if (allDocs != null && allDocs != undefined) {
            for (let i = 0; i < allDocs.length; i++) {
                ...
                let detailPayment;
                if (allPaymentDetail != null && allPaymentDetail != undefined && allPaymentDetail != "") {
                    detailPayment= allPaymentDetail.filter(payment => payment.id_documento == allDocs[i].id_documento);
                }
