                    ...
                    <ThemeProvider theme={theme}>
                        <AppBar elevation={0} position='fixed' color='primary' className={classes.style}>
                            <Toolbar>
                                ...
                                <Tabs classes={{ root: classes.tabStyle }} onChange={handleTabs} value={props.index}
                                    indicatorColor="secondary" textColor="primary"
                                    TabIndicatorProps={{
                                        style: { background: "#009639", width: "2%", height: "6%", marginLeft: "7%" }
                                    }}>
                                    <Tab className={classes.btn0Style} label='Iniciar sesión' />
