...
import NoticesViewPage from '../pages/noticesViewPage';
...
<BrowserRouter>
  ...
  <Route exact path='/notices/view' component={NoticesViewPage}/>
  <Route exact path='/notices/common-view' component={NoticesCommonViewPage}/>
